...
char char_array_apiario[5] = "";
char char_array_colmena[5] = "";
char char_array_temperatura[5] = "";
char char_array_humedad[5] = "";
char buf1[20];
...
void enviarDatos() {
    ...
    for( i =0; i < humedad.length(); i++ ) {
      if( i < 5 ) char_array_humedad[i] = humedad.charAt(i);
      else break;
    }
    ...
    Serial.println("AT+HTTPPARA=\"URL\",\"http://colmenainteligente.ddns.net/abeja2/?apiario_id=" + String(char_array_apiario).substring(0,2) + "&colmena_id=" + String(char_array_colmena).substring(0,2) + "&temperatura=" + String(char_array_temperatura).substring(0,5) +"&humedad=" + String(char_array_humedad).substring(0,5) + "&fecha_hora=" + String(buf1).substring(0,20) + "\""); // Envío En comando AT  
    serialSIM800L.println("AT+HTTPPARA=\"URL\",\"http://colmenainteligente.ddns.net/abeja2/?apiario_id=" + String(char_array_apiario).substring(0,2) + "&colmena_id=" + String(char_array_colmena).substring(0,2) + "&temperatura=" + String(char_array_temperatura).substring(0,5) +"&humedad=" + String(char_array_humedad).substring(0,5) + "&fecha_hora=" + String(buf1).substring(0,20) + "\""); // Envío En comando AT  
