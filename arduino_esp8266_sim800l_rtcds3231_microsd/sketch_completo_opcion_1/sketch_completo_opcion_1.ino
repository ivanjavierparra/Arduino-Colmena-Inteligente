...
// ==========================
// Permite la comunicación serial entre Arduino y 4 módulos: el ESP8266, el SIM800L, el RTCDS3231 y el MicroSD.
//
...
// se almacena dicho dato recibido en la tarjeta SD, y se envía dicho paquete por el SIM800L hacia la aplicación Laravel (Servidor web).
//
//  Pins
...
//  Arduino pin 4 to SIM800L RX
//  Arduino pin 5 to SIM800L TX
//  Connect GND from the Arduino to GND on the SIM800L
// 
